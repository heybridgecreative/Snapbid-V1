	...
	<?php include 'inc/nav.php' ?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">SnapBid Special Offers Manager</h1>
						<p>Here you can manage the special offers that are assigned to your account within the admin.</p>

						<?php include 'inc/specials.php' ?>
