<div id="header" class="navbar navbar-default navbar-fixed-top alt">
    <div class="container">
                ...
                <ul class="dropdown-nav-nav" style="display:block;">
					...
					<?php if(isset($_SESSION['username'])) : ?>
						...
						<p class="navbar-toggle account-toggle actbtn login collapsed mobile-right" style="float:none !important">
							<a class="non mobile" href="#loginReminder" role="button" data-toggle="modal" >Account</a>
					 	</p>
						</li>
				     ...
				     <?php else : ?>
						<li class="account">
					 	<p class="navbar-toggle actbtn login collapsed mobile-right">
							<a class="non mobile" href="#loginReminder" role="button" data-toggle="modal">Login</a>
