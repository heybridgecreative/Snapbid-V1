...
// AW API constants
define('API_USERNAME', '268649'); // AdvertiserService and PublisherService APIs only; your advertiser or publisher ID (for example: 1234 or 1234567)
define('API_PASSWORD', '68e89b48b089314b4c5cf2ffe24eb508b7ab3277bf51ec11'); // For the Advertiser Service API found under Settings / API Credentials / Hash
...
// PS API constants
define('API_KEY', '96c0545255feae9539525ce1d6e8c3be'); // ProductServe API only; activated by the publisher and once that has been done the password can be found under Settings / Manage API Credentials / ProductServe API Password
